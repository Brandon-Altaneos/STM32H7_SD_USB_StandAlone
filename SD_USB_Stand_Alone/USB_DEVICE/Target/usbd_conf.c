...
void HAL_PCD_MspInit(PCD_HandleTypeDef* pcdHandle)
{
  ...
  */
    ...
    */
    ...
    HAL_GPIO_Init(USB_HS_DIR_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = USB_HS_STP_Pin|USB_HS_NXT_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF10_OTG2_HS;
    ...
    GPIO_InitStruct.Pin = USB_HS_D0_Pin|USB_HS_CK_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF10_OTG2_HS;
...
void HAL_PCD_MspDeInit(PCD_HandleTypeDef* pcdHandle)
{
  ...
  /* USER CODE END USB_OTG_HS_MspDeInit 0 */
    ...
    PB5     ------> USB_OTG_HS_ULPI_D7
    */
    HAL_GPIO_DeInit(USB_HS_DIR_GPIO_Port, USB_HS_DIR_Pin);

    HAL_GPIO_DeInit(GPIOC, USB_HS_STP_Pin|USB_HS_NXT_Pin);

    HAL_GPIO_DeInit(GPIOA, USB_HS_D0_Pin|USB_HS_CK_Pin);
