...
#error ENABLE_SCRATCH_BUFFER MUST BE DEFINED
#endif

#if 0 // Place buffer in RAM_D1_NOCACHE 
...
#endif // Place buffer in RAM_D1_NOCACHE

RAM_D1_NOCACHE static uint8_t scratch[BLOCKSIZE];
