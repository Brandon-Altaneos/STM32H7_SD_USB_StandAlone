...
#ifdef DEFAULT_BSP_DRIVER_SD_CALLBACK
#include "usbdmsc.h"
#endif // DEFAULT_BSP_DRIVER_SD_CALLBACK
...
void HAL_SD_TxCpltCallback(SD_HandleTypeDef *hsd)
{
  ...
  USBDMSC_BSP_SD_WriteCpltCallback();
}
...
void HAL_SD_RxCpltCallback(SD_HandleTypeDef *hsd)
{
  ...
  USBDMSC_BSP_SD_ReadCpltCallback();
}
#else
...
__weak void BSP_SD_ErrorCpltCallback(void)
{
